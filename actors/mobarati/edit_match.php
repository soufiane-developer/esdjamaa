...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $conn->prepare("UPDATE matches SET link = :link, match_rank = :match_rank, opponent_team = :opponent_team, date = :date, time = :time, location = :location, referee = :referee WHERE id = :id");
    $stmt->execute([
        ':link' => $link,
