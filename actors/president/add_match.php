...
include '../../message_net.php'; ?>
    ...
    <?php foreach ($newsList as $news) : ?>
        <tr>
            ...
            <td>
                <a href="edit_match.php?id=<?= $news['id'] ?>" class="edit">Edit</a>
                <a href="" class="delete"  onclick="return confirm('هل أنت متأكد من حذف هذه المبارات?')">Delete</a>
